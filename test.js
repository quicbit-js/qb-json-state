...
test('explain', function (t) {
  t.table_assert([
    ...
    [ '{"',         null,  [ 3, 1, 2, 'E', 2, 2, '{', 'F', '' ],     'at limit before first key, src[2] {"-><-' ],
    [ '{"a',        null,  [ 3, 1, 2, 'E', 2, 2, '{', 'F', '' ],     'before first key, src[2] {"-><-a' ],
    [ '{ q',        null,  [ 3, 2, 2, 'E', 2, 3, '{', 'F', 'B' ],    'bad value, src[2..3] { ->q<-' ],
    [ '{ tq',       null,  [ 3, 2, 2, 'E', 2, 4, '{', 'F', 'B' ],    'bad value, src[2..4] { ->tq<-' ],
    [ '{ true',     null,  [ 3, 2, 2, 'E', 2, 6, '{', 'F', 'U' ],    'unexpected value, src[2..6] { ->true<-' ],
    [ '{"a',        null,  [ 3, 1, 3, 'E', 3, 3, '{', 'J', '' ],     'at limit before key, src[3] {"a-><-' ],
    [ '{"ab',       null,  [ 3, 1, 4, 'E', 4, 4, '{', 'J', 'T' ],    'truncated key, src[1..4] {->"ab<-' ],
    [ '{"a": trq',  null,  [ 3, 1, 4, 'E', 6, 9, '{', 'V', 'B' ],    'bad value, src[6..9] ..."a": ->trq<-' ],
    [ '{"a": "ab',  null,  [ 3, 1, 4, 'E', 6, 9, '{', 'U', 'T' ],    'truncated object value, src[6..9] ..."a": ->"ab<-' ],
    [ '{"a": "b"}', null,  [ 3, 1, 4, 'E', 4, 4, '{', 'L', '' ],     'after key, src[4] {"a"-><-: "b"...' ],
    [ '{"a"',       null,  [ 3, 1, 4, 'E', 4, 4, '{', 'L', '' ],     'at limit after key, src[4] {"a"-><-' ],
    [ '{"a": "b"}', null,  [ 3, 1, 4, 'E', 6, 6, '{', 'U', '' ],     'before object value, src[6] ..."a": -><-"b"}' ],
    [ '{"a": "b"}', null,  [ 3, 1, 4, 'E', 6, 9, '{', 'W', '' ],     'after object value, src[6..9] ..."a": ->"b"<-}' ],
    [ '{"a": "b",', null,  [ 3, 10, 10, 'E', 10, 10, '{', 'J', '' ], 'at limit before key, src[10] ... "b",-><-' ],
